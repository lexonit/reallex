...
import Property, { PropertyStatus } from '../models/Property.js';
import AuditLog from '../models/AuditLog.js';

// Configuration
const MONGODB_URI = 'mongodb+srv://lexonitservices_db_user:rK8FdwQHpTadfXlg@reallex.q5nxaar.mongodb.net/';
  ...
  try {
    ...
    const propertiesData = [
      ...
      },
      {
        ...
        location: { type: 'Point', coordinates: [-118.2694, 34.0867] },
      ...
      },
      {
        ...
        status: PropertyStatus.PUBLISHED,
        location: { type: 'Point', coordinates: [-118.3287, 34.1177] },
