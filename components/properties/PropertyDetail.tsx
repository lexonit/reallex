...
export const PropertyDetail: React.FC<PropertyDetailProps> = ({ property, onBack, onEdit }) => {
                          ...
                          {property.documents.map((doc, idx) => (
                              <div key={idx} className="flex items-center justify-between p-3 border rounded-lg hover:bg-muted/30 transition-colors">
                                  <div className="flex items-center gap-3">
                                      <div className="h-10 w-10 bg-red-500/10 text-red-600 rounded-lg flex items-center justify-center">
        ...
        <div className="space-y-6">
           ...
           <Card>
             ...
             <CardContent className="space-y-3">
               ...
               <Button className="w-full justify-between group hover:bg-red-50 hover:text-red-600 hover:border-red-200" variant="outline">
                 Archive Property <Trash2 className="h-4 w-4 text-muted-foreground group-hover:text-red-500" />
               </Button>
             </CardContent>
           </Card>
